...
O que são geradores?
    ...
    São definidos usando funcções regulares, mas, ao invés de retornar valores
...
Características de geradores
    ...
    daí na próxima vez que ele for chamado.

Exemplo: Recuperando dados de uma API
    - Solicitar por páginas (paginação).
    - Fornecer um produto por vez entre as chamadas.
    - Quando todos os produtos de uma página forem retornados,
    verificar se existem novas páginas.
