...
Isso impõe restrições ao acesso direto a variaveis e métodos e pode evitar a modificação
acidental de dados. Para evitar alterações acidentais, a variável de um objeto só pode
